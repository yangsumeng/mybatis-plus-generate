 ...
 */
public class LongquanCodeGenerator {
    private static String url = "jdbc:mysql://localhost:3306/test";
    private static String userName = "root";
    private static  String password = "";
    private static  String version = "LONGQUAN_BACKEND_V1.0.0";
    private static String outPutDir = "D:\\generator";
    private static boolean fileOverride = true;
    private static String[] includeArr = {"lq_province_info"};
    private static String tablePrefix = "lq_";
    private static String modelName = "province";
...
//    }
    ...
    private static String parent = "com.***.***.base";
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperServiceClass("com.***.***.base.service.base.IBaseService");
        strategy.setSuperServiceImplClass("com.***.***.base.service.base.impl.JpaBaseService");
        strategy.setSuperRepositoryClass("com.***.***.base.repository.base.IJpaBaseRepository");
        strategy.setSuperControllerClass("com.***.***.base.controller.base.BaseController");
...
//		final String mapperPath1 = mapperPath;
        ...
        fileOutList.add(new FileOutConfig("/template/js.vue.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return outPutDir + "\\" +modelName + "\\" + tableInfo.getEntityPath()+ ".js";
            }
        });

//        fileOutList.add(new FileOutConfig("/template/less.vue.vm") {
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                return outPutDir + "\\" +modelName + "\\" + tableInfo.getEntityPath()+ ".less";
//            }
//        });

        fileOutList.add(new FileOutConfig("/template/manage.vue.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return outPutDir + "\\" +modelName + "\\" + tableInfo.getEntityPath()+ "Manage.vue";
            }
        });

        fileOutList.add(new FileOutConfig("/template/addupdate.vue.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return outPutDir + "\\" +modelName + "\\" + "addAndUpdate" + tableInfo.getOriginalEntityName()+ ".vue";
            }
        });

        fileOutList.add(new FileOutConfig("/template/sql.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return outPutDir + "\\helper\\" + tableInfo.getEntityPath()+ "helper.sql";
            }
        });
